...
## 2.)Describe the process of setting up a new repository on GitHub. What are the key steps involved, and what are some of the important decisions you need to make during this process?
   To set up a new repository on GitHub follow the steps:
   
  1. Log in: Sign into GitHub and go to the "Repositories" tab.
  2. Create a New Repository: Click “New” to start a new repository.
...
* Experimentation: You can fork a repository to test new features or ideas without the risk of disrupting the original project
